...
export default class SwitchStatements implements CodeSmell {
  ...
  getDescription(): string {
    ...
    return (
      ...
      'criando uma subclasse (da classe com o "switch") para cada "case", criar um método abstrato na classe com ' +
      'o "switch" e passar o código de cada "case" para o novo método (que foram forçadas a declarar) de sua' +
      'respectiva subclasse. Essa nova estrutura deve substituir as ocorrências do "switch" origial.'
    );
  }
}
